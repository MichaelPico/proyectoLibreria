...
<html>
    <head>
        ...
        <title>Gestion Compras | Libreria Alpes</title>
    ...
    <body>
        ...
        <div class="row" >
            <div class="col-md-12 mb-2">+ <div class="py-3">
                    <div class="container">
                        <h2> Actualizar Estado Pedido</h2>
                        <div class="row">
                            <div class="col-md-12">
                                <form action="Scripts/scriptActualizarEstadoPedido.jsp">
                                    <div class="form-group row"> <label for="inputmailh" class="col-2 col-form-label">ID de el Usuario</label>
                                        <div class="col-10">
                                            <input type="number" class="form-control" placeholder="2" name="idUsuarioPedidoUpdate"> </div>
                                    </div>
                                <form action="Scripts/scriptActualizarEstadoPedido.jsp">
                                    <div class="form-group row"> <label for="inputmailh" class="col-2 col-form-label">ID de el pedido</label>
                                        <div class="col-10">
                                            <input type="number" class="form-control" placeholder="4" name="idPedidoUpdate"> </div>
                                    </div>
                                    <div class="form-group row"> <label class="col-2 col-form-label">Estado nuevo</label>
                                        <div class="col-10">
                                            <input type="text"class="form-control" placeholder="Enviado" name="estadoPedidoUpdate"> </div>
                                    </div>
            ...
            <%
                String todosPedidos = "";
                todosPedidos = Clases.Query.dibujarTodoLosHistorialesPedido();
            %>
